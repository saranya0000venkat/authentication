...
export default function Home() {
  ...
  useEffect(() => {
    axios.get('https://authentication-26bg.onrender.com/api/auth/me', { withCredentials: true })
      .then(r => setU(r.data.user))
      .catch(() => setU(null));
  }, []);

  const lg = async () => {
    await axios.post('https://authentication-26bg.onrender.com/api/auth/logout', {}, { withCredentials: true });
    setU(null);
  };
